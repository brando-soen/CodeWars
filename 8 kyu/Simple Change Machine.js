...
function changeMe(moneyIn){
    ...
    let twentyPenceChange = '10p 10p'
    let fiftyPenceChange = '20p 20p 10p'
    let onePoundChange = '20p 20p 20p 20p 20p'
    let twoPoundChange = onePoundChange + ' ' + onePoundChange
    let fivePoundChange = twoPoundChange + ' ' + twoPoundChange + ' ' + onePoundChange
        
    
    if (moneyIn === '£5'){
      return fivePoundChange
    } else if (moneyIn === '£2'){
      return twoPoundChange
    } else if (moneyIn === '£1'){
      return onePoundChange
    } else if (moneyIn === '50p'){
      return fiftyPenceChange
    } else if (moneyIn === '20p'){
      return twentyPenceChange
    } else {
      return moneyIn
    }
  }